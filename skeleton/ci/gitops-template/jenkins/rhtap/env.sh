...
export REKOR_HOST="http://rekor-server-rhtap-tas.apps.rosa.xjiang1122416a.c0x6.p3.openshiftapps.com"
...
export TUF_MIRROR="http://tuf-rhtap-tas.apps.rosa.xjiang1122416a.c0x6.p3.openshiftapps.com"
